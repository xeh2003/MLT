...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var BrowserFftFeatureExtractor = (function () {
        function BrowserFftFeatureExtractor(stream, config) {
            this.stream = stream
            var _this = this;
            if (config == null) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = this;
                            return [4, null] // getAudioMediaStream(audioTrackConstraints)];
                        case 1:
                            //_a.stream = _b.sent();
    ...
    var BrowserFftSpeechCommandRecognizer = (function () {
        ...
        BrowserFftSpeechCommandRecognizer.prototype.listen = function (stream, callback, config) {
            this.stream = stream
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.audioDataExtractor = new BrowserFftFeatureExtractor(stream, {
